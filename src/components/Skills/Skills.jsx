...
const allSkills = [
  // Frontend
  { name: "React JS", category: "frontend", tag: "Frontend", icon: <FaReact />, color: "#f59e0b" },
  ...
  { name: "CSS3", category: "frontend", tag: "Styling", icon: <FaCss3Alt />, color: "#f97316" },
  { name: "Responsive UI", category: "frontend", tag: "Design", icon: <MdDevices />, color: "#ea580c" },
  { name: "UI/UX Design", category: "frontend", tag: "Design", icon: <FaPaintBrush />, color: "#fbbf24" },
  ...
  { name: "Python", category: "backend", tag: "Language", icon: <SiPython />, color: "#f59e0b" },
  { name: "REST APIs", category: "backend", tag: "Integration", icon: <MdApi />, color: "#f97316" },
  { name: "Postman", category: "backend", tag: "API Testing", icon: <SiPostman />, color: "#ff6c37" },

  // AI & Tools
  { name: "AI Fundamentals", category: "tools", tag: "Intelligence", icon: <BsRobot />, color: "#facc15" },
  { name: "Git", category: "tools", tag: "VCS", icon: <FaGitAlt />, color: "#f05032" },
  { name: "GitHub", category: "tools", tag: "Collaboration", icon: <FaGithub />, color: "#fbbf24" },
  { name: "Video Editing", category: "tools", tag: "Media", icon: <FaVideo />, color: "#ea580c" },
  { name: "Vibe Coding", category: "tools", tag: "Workflow", icon: <FaBolt />, color: "#f59e0b" },

  // Soft Skills
  { name: "Problem Solving", category: "softskills", tag: "Analytical", icon: <FaBrain />, color: "#facc15" },
  { name: "Team Collaboration", category: "softskills", tag: "Teamwork", icon: <FaUsers />, color: "#f97316" },
  { name: "Communication", category: "softskills", tag: "Interpersonal", icon: <FaComments />, color: "#fbbf24" },
  { name: "Quick Learning", category: "softskills", tag: "Adaptability", icon: <FaLightbulb />, color: "#f59e0b" },
  { name: "Time Management", category: "softskills", tag: "Productivity", icon: <FaClock />, color: "#ea580c" },
  { name: "Critical Thinking", category: "softskills", tag: "Cognitive", icon: <FaBullseye />, color: "#d97706" },
];
